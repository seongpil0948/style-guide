...
테스트 현업 도입 가이드, 산출물 제공 방법, 개발규칙(Convention) 로 구성된 문서입니다.  
만약 **테스트** 또는 **playwright**에 생소하시거나 **필요성**에 대한 고민을 하고계시다면
아래 링크목록을 참조하세요.
...
먼저 테스트 작성의 **우선순위**를 정하여 점진적인 테스트 문화 도입을 목적으로 나아가야 합니다.  
...
우리는 자동화 테스트를 통해 위 문제를 해결 할 수 있습니다.

### 3.  [위험도/복잡도 기반 우선순위 결정](https://uzooin.tistory.com/185)
